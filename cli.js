...
// console.log( new NormalizedPath( "m 50,50 l 100,0 l 0,100 l -100,0 z" ).toString() );
// console.log( new NormalizedPath( "M 80 508 S 150 454 140 370 S 206 272 290 320 z" ).toString() );
console.log( new NormalizedPath( "M 300 300 A 50 50 90 1 1 400 300 A 50 50 90 1 1 300 300 z" ).toString() );
// console.log( new NormalizedPath( "m 80 508 s 70 -54 60 -138 s 66 -98 150 -50 z" ).toString() );